    ...
    this.update = (function () {
      return function update(delta) {
        ...
        if (this.moveForward || (this.autoForward && !this.moveBackward)) {
          ...
          // console.log('translateZ: ' + this.name, this.object.position, actualMoveSpeed + this.autoSpeedFactor);
        }
...
// True when the key event originated inside a text field (input, textarea,
// or any contenteditable) — so typing a note never drives the camera.
